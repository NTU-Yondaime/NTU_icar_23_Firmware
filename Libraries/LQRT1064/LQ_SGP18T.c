...
#define TFTSPI_CS     PT7_19    //CS   D11
#define TFTSPI_SCL    PT7_21    //SCL  D12
#define TFTSPI_SDA    PT7_20    //SDI  E12
#define TFTSPI_DC     PT7_15    //DC   E11
#define TFTSPI_RST    PT7_26    //RST  B13
...
{ 	
  ...
  /* 映射为GPIO7 GPIO6 - GPIO9挂载在AHB总线上 速度比较快 */
  IOMUXC_GPR->GPR27 = ((IOMUXC_GPR->GPR27 &(~(IOMUXC_GPR_GPR27_GPIO_MUX2_GPIO_SEL_MASK)))| IOMUXC_GPR_GPR27_GPIO_MUX2_GPIO_SEL(0x04388000U));
	
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_05_GPIO2_IO21,0x10F0u);                                                   
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_04_GPIO2_IO20,0x10F0u);
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_10_GPIO2_IO26,0x10F0u);
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_15_GPIO2_IO15,0x10F0u); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_03_GPIO2_IO19,0x10F0u); 
  //输出口管脚配置结构体
  ...
  GPIO_PinInit(GPIO7, 21, &GPIO_Output_Config);   
  GPIO_PinInit(GPIO7, 20, &GPIO_Output_Config);   
  GPIO_PinInit(GPIO7, 26, &GPIO_Output_Config);   
  GPIO_PinInit(GPIO7, 15, &GPIO_Output_Config);   
  GPIO_PinInit(GPIO7, 19, &GPIO_Output_Config);   
